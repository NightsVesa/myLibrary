...
Sprites are pre-rendered, **not generated at runtime**. The current frames live in `assets/pet_*.png` and are committed. The original motion frames were sliced from `docs/ptes.png` (a 2×2 1536×1024 sprite sheet) by an inline PIL script that:
